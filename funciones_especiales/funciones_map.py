# FUNCIÓN MAP
# Aplica una función a cada elemento de una lista iterable, devolviendo una lista con los resultados
...
def calculo_comision(empleado):
    ...
    if(empleado.salario) <= 3000:
        ...
        empleado.salario = empleado.salario * 1.03 # Que sume un 3% más del salario
